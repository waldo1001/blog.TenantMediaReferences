page 94781 "Tenant Media"
{
        ...
        area(content)
        {
            repeater(General)
            {
                ...
                field(WhereUsed; WhereUsedInfo)
                {
                    ...
                    var
                        WhereMediaUsedMeth: Codeunit "WhereMediaUsedDtls Meth";
                    begin
                        Message(WhereMediaUsedMeth.GetWhereUsedDetails(Rec));
                    end;
                }
    ...
    var
        WhereMediaUsedFirstMeth: Codeunit WhereMediaUsedInfoMeth;
    begin
        if not IsWhereUsedVisible then exit;

        WhereUsedInfo := WhereMediaUsedFirstMeth.GetWhereUsedInfo(Rec);
    end;
